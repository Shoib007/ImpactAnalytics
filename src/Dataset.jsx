...
import {useTable, usePagination, useExpanded, useGroupBy, useSortBy} from 'react-table';
...
const Dataset = () => {
    ...
    useEffect(() => {
        ...
        const columns = [
            ...
            {
                Header: 'Image', accessor: 'image', Cell: (props) => (
                    <img
                        src={props.row.original.image} alt="Food" width='40px'
                    />
                )
            },
